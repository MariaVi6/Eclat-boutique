const Descricao28Home = () => {
    ...
    <div className="descricao">
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Salto Alto Branco</h1>
            <h1 className="ref-produto">Salto | Alto | Ref: 204036291</h1>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-27-produto"></div>
            <div className="frete">
...
export default Descricao28Home;