    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-71"></div>
                <div className="img-1-72"></div>
            </div>
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Sobretudo Preto</h1>
            <h1 className="ref-produto">Blazer | Sobretudo | Ref: 204936291</h1>
            <div className="div-avaliacao-produto">
                ...
                <div className="avaliacao2-produto">4,0 (2.000 Avaliações)</div>
            </div>
            ...
            <div className="div27-cor-produto"></div>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-37-produto"></div>
            <div className="frete">
...
export default Descricao37Home;