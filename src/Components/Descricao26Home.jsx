    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-43"></div>
                <div className="img-1-44"></div>
            </div>
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Jaqueta Off Withe</h1>
            <h1 className="ref-produto">Jaqueta | Alfaiataria | Ref: 204436290</h1>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-25-produto"></div>
            <div className="frete">
...
export default Descricao26Home;