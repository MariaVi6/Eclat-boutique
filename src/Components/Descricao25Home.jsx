    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-49"></div>
                <div className="img-1-50"></div>
            </div>
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Sobretudo Bege</h1>
            <h1 className="ref-produto">Sobretudo | Blazer | Ref: 204436091</h1>
            ...
            <div className="precos-produto">
                <h1 className="preco-produto">R$300,00</h1>
            ...
            <div className="div19-cor-produto"></div>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-24-produto"></div>
            <div className="frete">
...
export default Descricao25Home;