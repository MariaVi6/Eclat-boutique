    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-37"></div>
                <div className="img-1-38"></div>
            </div>
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Saia Social Bege</h1>
            <h1 className="ref-produto">Saia | Social | Ref: 204436791</h1>
            ...
            <div className="div17-cor-produto"></div>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-22-produto"></div>
            <div className="frete">
...
export default Descricao23Home;