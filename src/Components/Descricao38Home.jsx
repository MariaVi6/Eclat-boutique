    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-73"></div>
                <div className="img-1-74"></div>
            </div>
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Sobretudo Listrado</h1>
            <h1 className="ref-produto">Blazer | Sobretudo | Ref: 204431291</h1>
            ...
            <div className="precos-produto">
                <h1 className="preco-produto">R$480,00</h1>
                <h1 className="preco2-produto">R$680,00</h1>
            </div>
            ...
            <div className="div28-cor-produto"></div>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-38-produto"></div>
            <div className="frete">
...
export default Descricao38Home;