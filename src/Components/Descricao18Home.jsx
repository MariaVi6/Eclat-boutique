...
const Descricao18Home = () => {
    ...
    <div className="descricao">
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Bolsa De Mão</h1>
            <h1 className="ref-produto">Acessorios | Bolsa | Ref: 212391829</h1>
            ...
            <div className="div15-cor-produto"></div>
    ...
    <div className="imagem-frete-produtos">
            <div className="img-2-17-produto"></div>
            <div className="frete">
...
export default Descricao18Home;