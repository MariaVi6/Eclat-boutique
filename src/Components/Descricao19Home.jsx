...
const Descricao19Home = () => {
    ...
    <div className="descricao">
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Anel Redondo Azul</h1>
            <h1 className="ref-produto">Acessorios | Aneis | Ref: 212301829</h1>
    ...
    <div className="imagem-frete-produtos">
            <div className="img-2-18-produto"></div>
            <div className="frete">
...
export default Descricao19Home;