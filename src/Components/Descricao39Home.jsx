    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-75"></div>
                <div className="img-1-76"></div>
            </div>
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Sobretudo Verde Musgo</h1>
            <h1 className="ref-produto">Blazer | Sobretudo | Ref: 204436291</h1>
            ...
            <div className="precos-produto">
                <h1 className="preco-produto">R$410,00</h1>
            ...
            <div className="div29-cor-produto"></div>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-39-produto"></div>
            <div className="frete">
...
export default Descricao39Home;