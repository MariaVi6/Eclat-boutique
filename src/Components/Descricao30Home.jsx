    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-59"></div>
                <div className="img-1-60"></div>
            </div>
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Camisa Sport Branca</h1>
            <h1 className="ref-produto">Camisa | Sport | Ref: 204416291</h1>
...
export default Descricao30Home;