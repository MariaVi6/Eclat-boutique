const Descricao43Home = () => {
    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-83"></div>
                <div className="img-1-84"></div>
            </div>
        </div>
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Colar Perolas</h1>
            <h1 className="ref-produto">Acessorios | Colar | Ref: 302394329</h1>
    ...
    <div className="imagem-frete-produtos">
            <div className="img-2-43-produto"></div>
            <div className="frete">
...
export default Descricao43Home;