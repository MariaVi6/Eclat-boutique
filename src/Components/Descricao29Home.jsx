    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-57"></div>
                <div className="img-1-58"></div>
            </div>
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Camisa Sport Cinza</h1>
            <h1 className="ref-produto">Camisa | Sport | Ref: 204436294</h1>
            ...
            <div className="div21-cor-produto"></div>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-28-produto"></div>
            <div className="frete">
...
export default Descricao29Home;