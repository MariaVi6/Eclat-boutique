...
const Descricao17Home = () => {
    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-33"></div>
                <div className="img-1-34"></div>
            </div>
        </div>
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Colar Prata Verde</h1>
            <h1 className="ref-produto">Acessorios | Colar | Ref: 202391829</h1>
            ...
            <div className="div14-cor-produto"></div>
    ...
    <div className="imagem-frete-produtos">
            <div className="img-2-16-produto"></div>
            <div className="frete">
...
export default Descricao17Home;