...
const Descricao41Home = () => {
    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-79"></div>
                <div className="img-1-80"></div>
            </div>
        </div>
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Brinco Bola</h1>
            <h1 className="ref-produto">Acessorios | Brincos | Ref: 202394329</h1>
    ...
    <div className="imagem-frete-produtos">
            <div className="img-2-41-produto"></div>
            <div className="frete">
...
export default Descricao41Home;