const Descricao22Home = () => {
    ...
    <div className="descricao">
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Camisa Social Azul</h1>
            <h1 className="ref-produto">Camisa | Social | Ref: 204736291</h1>
            ...
            <div className="precos-produto">
                <h1 className="preco-produto">R$160,00</h1>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-21-produto"></div>
            <div className="frete">
...
export default Descricao22Home;