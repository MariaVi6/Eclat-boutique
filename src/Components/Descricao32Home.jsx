const Descricao32Home = () => {
    ...
    <div className="descricao">
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Moletom Sport Verde</h1>
            <h1 className="ref-produto">Moletom | Sport | Ref: 204436292</h1>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-32-produto"></div>
            <div className="frete">
...
export default Descricao32Home;