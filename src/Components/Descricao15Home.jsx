const Descricao15Home = () => {
    ...
    <div className="descricao-2">
        <div className="imgs-2-produto">
            <div className="img-1-produto">
                <div className="img-1-29"></div>
                <div className="img-1-30"></div>
            </div>
        </div>
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Jaqueta Recortes</h1>
            <h1 className="ref-produto">Jaqueta | Jeans | Ref: 204436201</h1>
            <div className="div-avaliacao-produto">
                ...
                <div className="avaliacao2-produto">4,1 (1.000 Avaliações)</div>
            </div>
            ...
            Conjunto de anéis em prata 925 com design delicado e sofisticado. A peça combina a qualidade da prata de alta durabilidade com um design moderno e atemporal, perfeito para quem busca elegância discreta. Cada anel pode ser usado individualmente ou em conjunto.</div>
    ...
    <div className="imagem-frete-produtos">
            <div className="img-2-14-produto"></div>
            <div className="frete">
...
export default Descricao15Home;