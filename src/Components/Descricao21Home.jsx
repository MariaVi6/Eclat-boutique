const Descricao21Home = () => {
    ...
    <div className="descricao">
        ...
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Camisa Azul</h1>
            <h1 className="ref-produto">Social | Camisa | Ref: 206436291</h1>
            ...
            <div className="precos-produto">
                <h1 className="preco-produto">R$180,00</h1>
        ...
        <div className="imagem-frete-produtos">
            <div className="img-2-20-produto"></div>
            <div className="frete">
...
export default Descricao21Home;