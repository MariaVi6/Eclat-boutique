...
const Descricao20Home = () => {
    ...
    <div className="descricao">
        <div className="imgs-produto">
            <div className="img-1-produto">
                <div className="img-1-39"></div>
                <div className="img-1-40"></div>
            </div>
        </div>
        <div className="descricao-escrita-produto">
            <h1 className="titulo-produto">Brinco Redondo Verde</h1>
            <h1 className="ref-produto">Acessorios | Brinco | Ref: 212301821</h1>
            ...
            <div className="precos-produto">
                ...
                <h1 className="preco2-produto">R$190,00</h1>
            </div>
            ...
            <div className="div16-cor-produto"></div>
    ...
    <div className="imagem-frete-produtos">
            <div className="img-2-19-produto"></div>
            <div className="frete">
...
export default Descricao20Home;